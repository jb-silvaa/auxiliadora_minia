...
$sql1 = "SELECT usuario_id FROM mensajes WHERE mensaje_id = '$id' ";
...
notify("mensaje", $forUser, $rid, $usuario, 2);
...
$sql_last = "SELECT MAX(mensaje_historial_id) as mensaje_historial_id FROM mensajes_historial WHERE profesor_id = '$usuario' ";
...
/*echo ("<SCRIPT LANGUAGE='JavaScript'>
    ...
    window.location.href='mensaje_responder.php?id=$rid.php';
