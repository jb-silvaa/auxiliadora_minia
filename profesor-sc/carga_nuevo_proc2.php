...
if (isset($_FILES['files'])){	
	...
	if ($_FILES['files']['type']=='application/octet-stream' || $_FILES['files']['type']=='application/pdf' || $_FILES['files']['type']=='application/msword' || 
...
while($row_todos = mysqli_fetch_array($rs_todos)){
	...
	copy($para_copiar, $nombre_imagen);
			...
			echo "entre pero me cai ".$sql_imagen = "UPDATE cargas
