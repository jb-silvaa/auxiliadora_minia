...
$sql_clave = "SELECT * FROM profesores WHERE profesor_clave = '$clave'";
                    ...
                    <div class="col-lg-12">
                      ...
                      <form name="f1" method="POST" action="cambiar_clave_proc.php" enctype="multipart/form-data" onsubmit="comprobarClave()">
                            ...
                            <div class="info-50 margin-25">
                                ...
                                <input type="password" minlength="4" name="clavenuevabox1" id='clavenuevabox1' placeholder="ingrese nueva clave" value="<?=$row_clave['usuario_clave']?>">

                                <label>CONFIRME NUEVA CLAVE</label>

                                 <input type="password" minlength="4" name="clavenuevabox2" id='clavenuevabox2' placeholder="confirme su clave" value="<?=$row_clave['usuario_clave']?>">
