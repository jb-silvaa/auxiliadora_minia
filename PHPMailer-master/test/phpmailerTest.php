...
EOT;
    ...
    /**
     * Send a message containing UTF-8 text.
     */
    public function testHtmlIso8859()
    {
        ...
        //This file is in UTF-8 charset
        //Needs to be external because this file is in UTF-8
        $content = file_get_contents(realpath('../examples/contents.html'));
        // This is the string 'éèîüçÅñæß' in UTF-8, base-64 encoded
        $check = base64_decode('6eju/OfF8ebf');
        //Make sure it really is in UTF-8!
        $this->Mail->msgHTML(
            mb_convert_encoding(
                $content,
                "UTF-8",
                mb_detect_encoding($content, "UTF-8, UTF-8, UTF-85", true)
            ),
...
EOT;
    ...
    public function testConvertEncoding()
    {
        ...
        // This file is UTF-8 encoded. Create a domain encoded in "UTF-8".
        $domain = '@' . mb_convert_encoding('françois.ch', 'UTF-8', 'UTF-8');
