                    ...
                    <div class="col-lg-12">
                    	...
                    	<form method="POST" action="listado_cursos_modificar_proc.php" enctype="multipart/form-data">
                            ...
                            <div class="info-50 margin-25">
                                ...
                                <input type="hidden" name="docente" value="<?=$_GET['docente']?>">
                                <input type="hidden" name="asignatura" value="<?=$_GET['asignatura']?>">
                                <input type="hidden" name="nivel" value="<?=$_GET['nivel']?>">
                                <input type="hidden" name="letra" value="<?=$row_curso['letra_id']?>">
                                ...
                                <select name="profesor" class="minimal">
                                  ...
                                  while($row_profesor = mysqli_fetch_array($rs_profesor))
