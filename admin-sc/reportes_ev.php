            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <!--    <h1>RESUMEN GENERAL</h1> 
                        ...
                        $rs_desc = mysqli_query($conexion, $sql_desc);

                        $row_desc = mysqli_fetch_array($rs_desc);
                        ...
                        <div class="col-lg-12">
                            ...
                            <table class="header2" style="width: 100% !important; margin: 10px 0px !important; ">
                                ...
                                $sql_prof = "SELECT *, date_format(e.evaluacion_fecha, '%d-%m-%Y') as evaluacion_fecha_esp 
                                ...
                                {                         
                                    ...
                                    echo "<tr>                                                          
                                            ...
                                            <td>".$row_prof['evaluacion_fecha_esp']."</td> 
