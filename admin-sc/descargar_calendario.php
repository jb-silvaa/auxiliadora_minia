<?php
    ...
    if($nivel_tipo == 0){ $profesor_nombre = 'PRE-ESCOLAR'; } 
    if($nivel_tipo == 1){ $profesor_nombre = 'ENSEÑANZA BÁSICA'; } 
    if($nivel_tipo == 2){ $profesor_nombre = 'ENSEÑANZA MEDIA'; } 
    $sql_datos = "SELECT ca.curso_asignatura_id, 
                        ...
                        WHERE n.nivel_tipo = '$nivel_tipo' 
                        AND YEAR(e.evaluacion_fecha) = '$periodo_activo'
                        AND MONTH(e.evaluacion_fecha) = '$mes'
    ...
    <br><br><br><br>
        ...
        <tr>
            <th style="width:480px;font-size:80%;text-align:center;"><b>NIVEL: '.$profesor_nombre.'</b></th>
        </tr>
        </table>';
