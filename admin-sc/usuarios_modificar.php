...
$perfiles = $row_usuario['perfil_id'];
                    ...
                    <div class="col-lg-12">
                    	...
                    	<form method="POST" action="usuarios_modificar_proc.php" enctype="multipart/form-data" onsubmit="return validator();">
                            ...
                            <div class="info-50">
                                ...
                                <label>RUT (Sin punto ni guion)</label>
                                ...
                                <select name="perfil" required class="minimal">
                                  ...
                                  $sql_perfil = "SELECT * FROM perfiles WHERE perfil_estado = '1' ORDER BY perfil_id = '$perfiles' DESC, perfil_nombre ASC";
