...
$sql_per = "SELECT * FROM periodos WHERE periodo_activo = '1' ORDER BY periodo_periodo DESC";
$rs_per = mysqli_query($conexion, $sql_per);
$row_per = mysqli_fetch_array($rs_per);
$periodo = $row_per['periodo_periodo']/*date('Y')*/;
                        ...
                        <div class="col-lg-12" style="text-align: center;">
                            ...
                            <form method="POST" action="asignar_ayudante_proc.php" onsubmit="return validator();">
                                ...
                                <select name="profesor" required class="minimal">
                                    ...
                                    FROM profesores WHERE profesor_estado = 1 ORDER BY profesor_nombres, profesor_apellidos ASC";
                                ...
                                <select id="asignatura" name="asignatura" required class="minimal">
                                    ...
                                    FROM asignaturas as a, cursos_asignaturas as ca
