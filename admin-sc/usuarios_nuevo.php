            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                    	...
                    	<form method="POST" action="usuarios_nuevo_proc.php" enctype="multipart/form-data" onsubmit="return validator();">
                            ...
                            <div class="info-50">
                                ...
                                <select name="perfil" required class="minimal">
                                  ...
                                  $sql_perfil = "SELECT * FROM perfiles WHERE perfil_estado = '1'";

                                  $rs_perfil = mysqli_query($conexion, $sql_perfil);

                                  while($row_perfil = mysqli_fetch_array($rs_perfil))
                            ...
                            <div class="info-50">
                                ...
                                <input type="text" id="correo" name="correo" placeholder="INGRESE CORREO PERSONAL" onkeyup="reemplazar(this);">
