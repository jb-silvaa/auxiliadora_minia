                ...
                <div class="row">
							...
							$row_cursos = mysqli_fetch_array($rs_cursos);
							    ...
							    echo "
									...
									if($row_cursos['carga_archivo'] == ''){
										...
										<td>
											<?php if(is_file('../profesor-sc/'.$row_cursos['carga_archivo'])) { ?>
											<a id="myanchor<?=$row_cursos['carga_id']?>" download="<?=$curso."-".$asignatura.$row_cursos['carga_id'].".".$extension?>" href="../profesor-sc/<?=$carga_archivo?>"><i class='fas fa-search fa-lg' id='open<?=$row_cursos['carga_id']?>'></i></a>
											<?php }else{ ?><i style='cursor: pointer; color:red;' class='fas fa-search fa-lg' id='open<?=$row_cursos['carga_id']?>'></i><?php } ?>
										</td>										
										...
										$(document).ready(function(){
										    ...
										    $('#open<?=$row_cursos['carga_id']?>').on('click', function(){
												...
												$("#myanchor<?=$row_cursos['carga_id']?>")[0].click();
									...
									if($row_cursos['carga_aprobacion'] == '0' && $row_cursos['carga_archivo'] != '' && $row_cursos['carga_archivo'] != null)
									{
					...
					<table class="header2">
						...
						$row_cursos = mysqli_fetch_array($rs_cursos);
								...
								$path = $row_cursos['carga_archivo'];
                                $extension = pathinfo($path, PATHINFO_EXTENSION);
								$cargaanual = "ANUAL ".$row_cursos['nivel_nombre']."-".$row_cursos['letra_nombre']."-".$row_cursos['asignatura_nombre'].".".$extension;
								...
								?>
									...
									<td>
										<?php if(is_file('../profesor-sc/'.$row_cursos['carga_archivo'])) { ?>
											<a id="anchor<?=$row_cursos['carga_id']?>" download="<?=$cargaanual?>" href="../profesor-sc/<?=$row_cursos['carga_archivo']?>"><i class='fas fa-search fa-lg' id='open<?=$row_cursos['carga_id']?>'></i></a>
											<?php }else{ ?><i style='cursor: pointer; color:red;' class='fas fa-search fa-lg' id='open<?=$row_cursos['carga_id']?>'></i><?php } ?>
										...
										$(document).ready(function(){
										    ...
										    $('#open<?=$row_cursos['carga_id']?>').on('click', function(){
										        ...
										        $("#anchor<?=$row_cursos['carga_id']?>")[0].click();
