...
$sql_limite = "SELECT * FROM periodos WHERE periodo_id = '$id'";

$rs_limite = mysqli_query($conexion, $sql_limite);

$row_limite = mysqli_fetch_array($rs_limite);
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                    	...
                    	<form method="POST" action="periodo_limite_modificar_proc.php" enctype="multipart/form-data" onsubmit="return validator();" >

                            <div class="info-50 margin-25">



                                <input type="hidden" name="id" value="<?=$row_limite['periodo_id']?>"> <!--ID DEL PERIODO-->
