            ...
            <div id="page-content-wrapper">
                            ...
                            <div class="filtros4">
                                <form method="GET">
                                    ...
                                    <select id="mes" name="mes" required class="minimal">
                                        ...
                                        $rs_mes = mysql_query($sql_mes, $conexion);
                                        while($row_mes = mysql_fetch_array($rs_mes))
                                        {
                ...
                <?php
                    ...
                    while ($row = mysql_fetch_array($rs)) {  
                        ...
                        {                      
                        setlocale (LC_TIME, "es_ES"); echo '</table><h1>'.utf8_encode( strftime("%A, %d de %B de %Y", strtotime($row['evaluacion_fecha'])) ).'</h1>
                        <table class="header2">
                                <tr>
                                    <th>Asignatura</th>
                                    <th>Profesor</th>
