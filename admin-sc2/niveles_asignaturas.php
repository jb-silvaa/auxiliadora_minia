                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        while($row = mysql_fetch_array($rs))
                        {
                            ...
                            echo "<tr>
                                    <td style='border-top:2px solid black' rowspan=".$rowspan.">".$row['nivel_nombre']."</td>";    
                            ...
                            while ($row_asig = mysql_fetch_array($rs_asig)) {
                                if($contador == '1')
                                {
                                    echo "<td style='border-top:2px solid black' >".$row_asig['asignatura_nombre']."</td>";
                                    echo "<td style='border-top:2px solid black'  rowspan=".$rowspan."><a href='niveles_asignaturas_modificar.php?id=".$row['nivel_id']."'><i class='fas fa-search fa-lg'></i></a></td></tr>";
                                }
                                else
                                {
