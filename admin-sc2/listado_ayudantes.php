        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-12">
                            <h1 style="text-align:left;float:left;">LISTADO AYUDANTES</h1> 
                            <a href="asignar_ayudante.php" class="btn btn-default btn-lg active" role="button" style="text-align:right;float:right;margin-right:5px">Asignar Ayudante</a>
                            <div class="filtros4">
                                <form method="GET">
                                    <label>Año</label>
                            ...
                            <table class="header2">
                                ...
                                while($row_prof = mysql_fetch_array($rs_prof)){                         
                                    ...
                                    <td><a href='ayudante_eliminar.php?id=<?=$row_prof['ayudante_id']?>' onclick ="javascript: return confirm('Desea Eliminar Este Archivo?');"><i class='far fa-times-circle fa-lg'></i></a></td>
                                    <?php
                        		  echo "</tr>";
                                    $dificultad = '';
                                    $contador++;
