...
$rs_clave = mysql_query($sql_clave, $conexion);
$row_clave = mysql_fetch_array($rs_clave);
?>
                    ...
                    <div class="col-lg-12">
                      ...
                      <form name="f1" method="POST" action="cambiar_claveadm_proc.php" enctype="multipart/form-data" onsubmit="comprobarClave()">
                            <div class="info-50 margin-25">
                                ...
                                <input type="text" minlength="4" name="clavenuevabox1" id='clavenuevabox1' placeholder="ingrese nueva clave" onkeyup="reemplazar(this);" value="<?=$row_clave['usuario_clave']?>">
                                <label>CONFIRME NUEVA CLAVE</label>
                                 <input type="text" minlength="4" name="clavenuevabox2" id='clavenuevabox2' placeholder="confirme su clave" onkeyup="reemplazar(this);" value="<?=$row_clave['usuario_clave']?>">
