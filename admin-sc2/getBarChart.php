...
$result = mysql_query($sqlQuery,$conexion);

while($row_asig = mysql_fetch_array($result)){
    ...
    $row_asig1 = mysql_fetch_array($result1);
    $carga = $row_asig1[0];
    ...
    $result2 = mysql_query($sql1,$conexion);
    $row_asig2 = mysql_fetch_array($result2);
