                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="filtros4">
                            ...
                            $sql_pie = "SELECT count(carga_id) as total_anual 
                                        ...
                                        $asignatura_filtro_pie
                                        ";
                            $rs_pie = mysql_query($sql_pie, $conexion);
                            $row_pie = mysql_fetch_array($rs_pie);
                            ...
                            $asignatura_filtro_pie
                            ";
                            $rs_pie_f = mysql_query($sql_pie_f, $conexion);
                            $row_pie_f = mysql_fetch_array($rs_pie_f);
                            ...
                            $sql_pie_a = "SELECT count(carga_id) as total_aceptada 
                                        ...
                                        $asignatura_filtro_pie
                                        ";
                            $rs_pie_a = mysql_query($sql_pie_a, $conexion);
                            $row_pie_a = mysql_fetch_array($rs_pie_a);
                            ...
                            $sql_pie_r = "SELECT count(carga_id) as total_rechazada
                                        ...
                                        $asignatura_filtro_pie
                                        ";
                            $rs_pie_r = mysql_query($sql_pie_r, $conexion);
                            $row_pie_r = mysql_fetch_array($rs_pie_r);
                        ...
                        <div class="col-lg-12">
                            ...
                            <table class="header2" style="width: 100% !important; margin: 10px 0px !important; ">
                                ...
                                while($row_prof = mysql_fetch_array($rs_prof)){
                                    $cargaanual = "ANUAL ".$row_prof['nivel_nombre']."-".$row_prof['letra_nombre']."-".$row_prof['asignatura_nombre'];
                                    ...
                                    $rs_avance_r = mysql_query($sql_avance_r, $conexion);
                                    $row_avance_r = mysql_fetch_array($rs_avance_r);
                                    ...
                                    $rs_avance = mysql_query($sql_avance, $conexion);
                                    $row_avance = mysql_fetch_array($rs_avance);
                                    ...
                                    $rs_avance_sa = mysql_query($sql_avance_sa, $conexion);
                                    $row_avance_sa = mysql_fetch_array($rs_avance_sa);
                                    ...
                                    AND ca.dificultad_id = '$dif'
                                    $periodo_filtro_tabla";
                                    $rs_avance2 = mysql_query($sql_avance2, $conexion);
                                    $row_avance2 = mysql_fetch_array($rs_avance2);
                                    ...
                                    $rs_avance_a = mysql_query($sql_avance_a, $conexion);
                                    $row_avance_a = mysql_fetch_array($rs_avance_a);
                                    ...
                                    $rs_avance_a2 = mysql_query($sql_avance_a2, $conexion);
                                    $row_avance_a2 = mysql_fetch_array($rs_avance_a2);
                                    ...
                                    $rs_avance_ra = mysql_query($sql_avance_ra, $conexion);
                                    $row_avance_ra = mysql_fetch_array($rs_avance_ra);
