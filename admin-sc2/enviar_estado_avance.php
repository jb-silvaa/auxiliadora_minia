...
$row_data = mysql_fetch_array($rs_data);
    ...
    while ($row_cursos = mysql_fetch_array($rs_curso)) {
        ...
        $rs_unidad_sr = mysql_query($sql_unidad_sr, $conexion);
        $row_unidad_sr = mysql_fetch_array($rs_unidad_sr);
        ...
        $rs_unidad_r = mysql_query($sql_unidad_r, $conexion);
        $row_unidad_r = mysql_fetch_array($rs_unidad_r);
        ...
        $rs_anual_sr = mysql_query($sql_anual_sr, $conexion);
        $row_anual_sr = mysql_fetch_array($rs_anual_sr);
